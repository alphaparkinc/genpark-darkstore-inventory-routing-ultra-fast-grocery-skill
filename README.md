# genpark-darkstore-inventory-routing-ultra-fast-grocery-skill
...
> **GenPark AI Agent Skill** -- 15-minute ultra-fast grocery delivery dispatcher and darkstore picker router (Ninja style)
